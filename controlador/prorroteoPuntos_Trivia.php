<!-- <?php
	...
	$Consulta_2= "SELECT DATE_FORMAT(HoraMaximo, '%H:%i:%s') FROM respuestas_trivias WHERE ID_ParticipanteTrivia='$ID_ParticipanteTrivia' AND ID_Pregunta='$Pregunta'";
	...
	$Consulta_5= "SELECT DATE_FORMAT(Hora_Respuesta, '%H:%i:%s') FROM respuestas_trivias WHERE ID_ParticipanteTrivia='$ID_ParticipanteTrivia' AND ID_Pregunta='$Pregunta'";
