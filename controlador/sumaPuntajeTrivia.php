<?php 
	...
	$ParticipanteTrivia= $_GET["val_3"];//recibe el ID_Participante desde puntaje.js
	//  echo "ID_ParticipanteTrivia= " . $ParticipanteTrivia;

	//Consulta realizada para obtener el puntaje del participante despues de haber actualizado 
	$Consulta="SELECT * FROM participante_trivia WHERE ID_ParticipanteTrivia='$ParticipanteTrivia'";
