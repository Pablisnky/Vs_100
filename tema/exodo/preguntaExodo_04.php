...
<html lang="es">
	...
	<body onload="llamar_puntaje()"><!--funcion Ajax en puntaje.js que accede a BD para sumar el puntaje del participante -->
		...
		<?php
    		...
    		$_SESSION["Pregunta"] = 14;//se crea la SESION pregunta, necesaria en Temporizador_2	
		...
		?>
			...
			<input type="text" class="ocultar" id="ID_Pregunta" hidden value= "14">
		...
		<?php
			...
			$Consulta_3="SELECT * FROM respuestas WHERE ID_Participante='$participante' AND Correcto='1' AND ID_Pregunta = 13";
		...
		<div class="Secundario">
			...
			<h4>Pregunta Nº 14</h4>
			<div class="pregunta">
				<p>¿Cuando Moises huía del Faraón porque este trató de matarlo, se fue hacia:?</p>
			</div>
			<div class="Quinto">
				<ul>
					<li id="principiantes_04a" class="efecto" onclick="cerrar(); sombrear_04a(); llamar_bloqueo()">La tierra prometida.</li>
					<li id="principiantes_04b" class="efecto" onclick="cerrar(); sombrear_04b(); llamar_bloqueo()">A Jerusalen.</li>
					<li id="principiantes_04c" class="efecto" onclick="cerrar(); llamar_sombrear_04c(); setTimeout(llamar_puntaje,200);">La tierra de Madián.</li>
					<li id="principiantes_04d" class="efecto" onclick="cerrar(); sombrear_04d(); llamar_bloqueo()">Al Rio Nilo.</li>
				</ul>
			</div>
			...
			<nav class="navegacion_1">
				...
				<div class="nav_2"><a class="nav_7" href="../exodo/preguntaExodo_05.php">Siguiente</a></div>
			</nav>
		</div>
		<aside>
...
<script>
function sombrear_04a(){
	var A= document.getElementById("principiantes_04a");
	var B= document.getElementById("principiantes_04b");
	var C= document.getElementById("principiantes_04c");
	var D= document.getElementById("principiantes_04d");
...
function llamar_sombrear_04c(){
    ...
    var url="respuestaExodo_04.php?val_1=" + E  + "&val_2=" + F + "&r=" + aleatorio;
    http_request.open('GET',url,false);     
    peticion.onreadystatechange = respuesta_sombrear_04c;
    peticion.setRequestHeader("content-type","application/x-www-form-urlencoded");
    peticion.send("null");
}                                                           
function respuesta_sombrear_04c(){
	...
	D.style.borderColor="black";
		...
		?>
			<div class="Secundario">
				...
				<div class="Cuarto_4">
					<p>No ha respondido correctamente la pregunta Nº 13, debe dar una respuesta correcta</p>
				</div>
				<br>
				<nav class="navegacion">
					<div class="nav_2"><a href="preguntaExodo_03.php">Volver</a></div>
				</nav>
			</div>
			<aside>
				<!--<img src="../../images/logo_1.png">-->
