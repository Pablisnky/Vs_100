...
<html lang="es">
	...
	<body onload="llamar_puntaje()"><!--funcion Ajax en puntaje.js que accede a BD para sumar el puntaje  del participante -->
		...
		<?php
    		...
    		$_SESSION["Pregunta"] = 13;//se crea la SESION pregunta, necesaria en Temporizador_2	
		...
		?>
			...
			<input type="text" class="ocultar" id="ID_Pregunta" hidden value= "13">
		...
		<?php
			...
			$Consulta_3="SELECT * FROM respuestas WHERE ID_Participante='$participante' AND Correcto='1' AND ID_Pregunta = 12";
		...
		<div class="Secundario">
			...
			<h4>Pregunta Nº 13</h4> 
			<div class="pregunta">
				<p>En una oportunidad, Aarón levanto su vara y golpeó las aguas del Rio Nilo. En ese momento, por el poder de Dios el agua del río se convirtio en:</p>
			</div>
			<div class="Quinto">
				<ul>
					<li id="principiantes_03a" class="efecto" onclick="cerrar(); llamar_sombrear_03a(); setTimeout(llamar_puntaje,200);">Sangre.</li>
					<li id="principiantes_03b" class="efecto" onclick="cerrar(); sombrear_03b(); llamar_bloqueo()">Vino.</li>
					<li id="principiantes_03c" class="efecto" onclick="cerrar(); sombrear_03c(); llamar_bloqueo()">Agua salada.</li>
					<li id="principiantes_03d" class="efecto" onclick="cerrar(); sombrear_03d(); llamar_bloqueo()">Hielo.</li>
				</ul>
			</div>
			...
			<nav class="navegacion_1">
				...
				<div class="nav_2"><a class="nav_7" href="../exodo/preguntaExodo_04.php">Siguiente</a></div>
			</nav>
		</div>
		<aside>
...
function llamar_sombrear_03a(){
	...
	var B= document.getElementById("principiantes_03b");
	var C= document.getElementById("principiantes_03c");
	var D= document.getElementById("principiantes_03d");
	A.style.color="white";
    ...
    var url="respuestaExodo_03.php?val_1=" + E  + "&val_2=" + F + "&r=" + aleatorio;
    http_request.open('GET',url,false);     
    peticion.onreadystatechange = respuesta_sombrear_03c;
    peticion.setRequestHeader("content-type","application/x-www-form-urlencoded");
    peticion.send("null");
}                                                           
function respuesta_sombrear_03c(){
	...
	D.style.borderColor="black";
		...
		?>
			<div class="Secundario">
				...
				<div class="Cuarto_4">
					<p>No ha respondido correctamente la pregunta Nº 12, debe dar una respuesta correcta</p>
				</div>
				<br>
				<nav class="navegacion">
					<div class="nav_2"><a href="preguntaExodo_02.php">Volver</a></div>
				</nav>
			</div>
			<aside>
				<!--<img src="../../images/logo_1.png">-->
