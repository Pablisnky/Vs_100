<?php
    ...
    //echo $Pregunta . "<br>";
  	...
  	$Tema= $_SESSION["Tema"];//sesion creada en preguntaXXXX_00.php
				...
				$Consulta_2= "SELECT  DATE_FORMAT(HoraMaximo, '%H:%i:%s') FROM respuestas WHERE ID_Participante ='$Participante' AND ID_Pregunta='$Pregunta' AND Tema ='$Tema'";
				...
				if($TiempoRespuesta >= '00:01:30'){
					$Premio=5;
					$Sumar="UPDATE participantes_pruebas SET Puntos= (Puntos + $Premio) WHERE ID_Participante='$Participante'";
