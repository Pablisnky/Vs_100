	...
	<body onload="llamar_puntaje()"><!--funcion Ajax en puntaje.js que accede a BD para sumar el puntaje del participante -->
		...
		<div class="Secundario">
			...
			<nav class="navegacion_1">
				...
				<div class="nav_2"><a class="nav_7" href="ultimaCristianismo.php">Siguiente</a></div>
			</nav>
		</div>
	</body>
</html>
...
function llamar_sombrear_10c(){
	var D= document.getElementById("principiantes_10c");
	D.style.color="black";
    ...
    peticion.onreadystatechange = respuesta_sombrear_10c;
    peticion.setRequestHeader("content-type","application/x-www-form-urlencoded");
    peticion.send("null");
}
function respuesta_sombrear_10c(){
		...
		?>
					<div class="Secundario">
						...
						<div class="Cuarto_4">
							...
							<a class="nav_1" href="preguntaCristianismo_09.php">Volver</a>
					</div>
		<?php
			}}
		?>