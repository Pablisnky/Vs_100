...
<html lang="es">
	...
	<body onload="llamar_puntaje()"><!--funcion Ajax en puntaje.js que accede a BD para sumar el puntaje del participante -->
		...
		<div class="Secundario">
			...
			<div class="Quinto">
				<div class="Quinto_2">
					<p id="principiantes_09a" class="efecto" onclick="llamar_sombrear_09a(); setTimeout(llamar_puntaje,200);">Josue.</p>
			...
			<nav class="navegacion_1">
				...
				<div class="nav_2"><a class="nav_7" href="preguntaCristianismo_10.php">Siguiente</a></div>
			</nav>
		</div>
	</body>
</html>
...
function llamar_sombrear_09a(){
	var D= document.getElementById("principiantes_09a");
	D.style.color="black";
    ...
    peticion.onreadystatechange = respuesta_sombrear_09a;
    peticion.setRequestHeader("content-type","application/x-www-form-urlencoded");
    peticion.send("null");
}
function respuesta_sombrear_09a(){
	...
	<?php
		...
		?>
			<div class="Secundario">
				...
				<a class="nav_1" href="preguntaCristianismo_08.php">Volver</a>
			</div>
		<?php
			}
		}
