		...
		<div class="Secundario">
			...
			<div class="Quinto">
				<div class="Quinto_2">
					...
					<p id="principiantes_06b" class="efecto" onclick="llamar_sombrear_06b(); setTimeout(llamar_puntaje,200);">Trabajar forzosamente.</p>
				</div>
				<div class="Quinto_2">
			...
			<nav class="navegacion_1">
				...
				<div class="nav_2"><a class="nav_7" href="preguntaCristianismo_07.php">Siguiente</a></div>
			</nav>
		</div>
	</body>
</html>
		...
		?>
					<div class="Secundario">
						...
						<div class="Cuarto_4">
							...
							<a class="nav_1" href="preguntaCristianismo_05.php">Volver</a>
					</div>
		<?php
			}}
		?>