	...
	<body onload="llamar_puntaje()"><!--funcion Ajax en puntaje.js que accede a BD para sumar el puntaje del participante -->
	    ...
	    <div class="Secundario">
			...
			<div class="Quinto">
				...
				<div class="Quinto_2">
					<p id="principiantes_02c" class="efecto" onclick="llamar_sombrear_02c(); setTimeout(llamar_puntaje,200);">Su hermano.</p>
			...
			<nav class="navegacion_1">
				...
				<div class="nav_2"><a class="nav_7" href="preguntaCristianismo_03.php">Siguiente</a></div>
			</nav>
		</div>	
	</body>
</html>
		...
		?>
					<div class="Secundario">
						...
						<div class="Cuarto_4">
							...
							<a class="nav_1" href="preguntaCristianismo_01.php">Volver</a>
					</div>
				<?php
			}
	}
