...
<html lang="es">
	...
	<body onload="llamar_puntaje()"><!--funcion Ajax en puntaje.js que accede a BD para sumar el puntaje del participante -->
		...
		<div class="Secundario">
			...
			<div class="Quinto">
				<div class="Quinto_2">
					<p id="principiantes_05a" class="efecto" onclick="lamar_bloqueo()">Sefora.</p>
				...
				<div class="Quinto_2">
					...
					<p id="principiantes_05d" class="efecto" onclick="llamar_sombrear_05d(); setTimeout(llamar_puntaje,200);">Dios.</p>
				</div>
			</div>
			...
			<nav class="navegacion_1">
				...
				<div class="nav_2"><a class="nav_7" href="preguntaCristianismo_06.php">Siguiente</a></div>
			</nav>
		</div>
	</body>
</html>
		...
		?>
					<div class="Secundario">
						...
						<div class="Cuarto_4">
							...
							<a class="nav_1" href="preguntaCristianismo_04.php">Volver</a>
					</div>
		<?php
			}}
		?>