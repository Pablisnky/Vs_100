...
<html lang="es">
	...
	<body onload="llamar_puntaje()"><!--funcion Ajax en puntaje.js que accede a BD para sumar el puntaje del participante -->
		...
		<div class="Secundario">
			...
			<div class="Quinto">
				<div class="Quinto_2">
					<p id="principiantes_07a" class="efecto" onclick="llamar_bloqueo()">El evangelio de Cristo.</p>
					<p id="principiantes_07b" class="efecto" onclick="llamar_bloqueo()">Un Don espiritual.</p>
				</div>
				<div class="Quinto_2">
					<p id="principiantes_07c" class="efecto" onclick="llamar_bloqueo()">Clase de armar tiendas .</p>
					<p id="principiantes_07d" class="efecto" onclick="llamar_sombrear_07d(); setTimeout(llamar_puntaje,200);">Como llego a ser cristiano.</p>
				</div>
			</div>
			...
			<nav class="navegacion_1">
				...
				<div class="nav_2"><a class="nav_7" href="preguntaCristianismo_08.php">Siguiente</a></div>
			</nav>
		</div>
	</body>
</html>
		...
		?>
					<div class="Secundario">
						...
						<div class="Cuarto_4">
							...
							<a class="nav_1" href="preguntaCristianismo_06.php">Volver</a>
					</div>
		<?php
			}}
		?>