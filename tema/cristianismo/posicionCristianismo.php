...
session_start();//se inicia sesion para llamar a las variables $_SESSION creadas en otros archivos, o para crearlas si es necesario
	...
	$Puntaje= mysqli_num_rows($Recordset);//se suman los registros que tiene la consulta realizada.
	 echo "Puntos: " . $Puntaje;
		if ($Puntaje==0){
				header("location:preguntaCristianismo_01.php");
		}
		else if ($Puntaje==1){
				header("location:preguntaCristianismo_02.php");
		}
		else if ($Puntaje==2){
				header("location:preguntaCristianismo_03.php");
		}
		else if ($Puntaje==3){
				header("location:preguntaCristianismo_04.php");
		}
		else if ($Puntaje==4){
				header("location:preguntaCristianismo_05.php");
		}
		else if ($Puntaje==5){
				header("location:preguntaCristianismo_06.php");
		}
		else if ($Puntaje==6){
				header("location:preguntaCristianismo_07.php");
		}
		else if ($Puntaje==7){
				header("location:preguntaCristianismo_08.php");
		}
		else if ($Puntaje==8){
				header("location:preguntaCristianismo_09.php");
		}
		else if ($Puntaje==9){
				header("location:preguntaCristianismo_10.php");
		}
		else if ($Puntaje==10){
				header("location:ultimaCristianismo.php");
		}
