		...
		<div class="Secundario">
			...
			<div class="Quinto">
				<div class="Quinto_2">
					...
					<p id="principiantes_08b" class="efecto" onclick="llamar_sombrear_08b(); setTimeout(llamar_puntaje,200);">Aarón.</p>
				</div>
				<div class="Quinto_2">
			...
			<nav class="navegacion_1">
				...
				<div class="nav_2"><a class="nav_7" href="preguntaCristianismo_09.php">Siguiente</a></div>
			</nav>
		</div>
	</body>
</html>
...
function llamar_sombrear_08b(){
	var D= document.getElementById("principiantes_08b");
	D.style.color="black";
    ...
    peticion.onreadystatechange = respuesta_sombrear_08b;
    peticion.setRequestHeader("content-type","application/x-www-form-urlencoded");
    peticion.send("null");
}
function respuesta_sombrear_08b(){
		...
		?>
					<div class="Secundario">
						...
						<div class="Cuarto_4">
							...
							<a class="nav_1" href="preguntaCristianismo_07.php">Volver</a>
					</div>
		<?php
			}}
		?>