...
// session_start();//se inicia sesion para llamar las variables $_SESSION creadas en otros archivos, o para crear una.
	...
	if(!isset($_SESSION["ID_Participante"])){//sino hay nada almacenado en la variable superglobal devuelve a la pagina de inicio
		...
		<div>
			<p class="pregunta">Cuando parte de tribus rechazaron el liderazgo de Roboan, este reinó solo en las tribus que habitaban en:</p>
		</div>
		<div class="Quinto">
			<div class="Quinto_2">      
				<p id="principiantes_01a" class="efecto" onclick="sonidoInCorrecto(); pauseAudioBiblia();llamar_bloqueo()">Jerusalén</p>
				<p id="principiantes_01b" class="efecto" onclick="sonidoInCorrecto(); pauseAudioBiblia();llamar_bloqueo()">Siquem</p>
			</div>
			<div class="Quinto_2">
		...
		<?php
		$_SESSION["Versiculo"] = "2 Crónicas 10:17";
	}  
