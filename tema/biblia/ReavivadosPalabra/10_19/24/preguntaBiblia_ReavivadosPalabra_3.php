...
// session_start();//se inicia sesion para llamar las variables $_SESSION creadas en otros archivos, o para crear una.
	...
	if(!isset($_SESSION["ID_Participante"])){//sino hay nada almacenado en la variable superglobal devuelve a la pagina de inicio
		...
		<div>
			<p class="pregunta">¿A que pais huyo Jeroboam,  luego que Salomón procurara matarlo? </p>
		</div>
		<div class="Quinto">
			<div class="Quinto_2">      
			...
			<div class="Quinto_2">
				<p id="principiantes_01b" class="efecto" onclick="sonidoInCorrecto(); pauseAudioBiblia();llamar_bloqueo()">Persia</p>
				<p id="principiantes_01a" class="efecto" onclick="sonidoInCorrecto(); pauseAudioBiblia();llamar_bloqueo()">Siria</p>
			</div>
		</div
		<?php
		$_SESSION["Versiculo"] = "2 de Crónicas 10:2";
	}  
