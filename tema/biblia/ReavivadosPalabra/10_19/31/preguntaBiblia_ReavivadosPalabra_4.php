...
// session_start();//se inicia sesion para llamar las variables $_SESSION creadas en otros archivos, o para crear una.
	...
	if(!isset($_SESSION["ID_Participante"])){//sino hay nada almacenado en la variable superglobal devuelve a la pagina de inicio
		...
		<div>
			<p class="pregunta">________, confirmó el reino de Josafat sobre Judá, y tuvo riquezas y gloria en abundancia.</p>
		</div>
		<div class="Quinto">
			<div class="Quinto_2">            
			...
			<div class="Quinto_2">
				<p id="principiantes_01d" class="efecto" onclick="sonidoInCorrecto(); pauseAudioBiblia();llamar_bloqueo()">El ejercito</p>
		...
		<?php
		$_SESSION["Versiculo"] = "2 Crónicas 17:5";
	}  
