...
// session_start();//se inicia sesion para llamar las variables $_SESSION creadas en otros archivos, o para crear una.
	...
	if(!isset($_SESSION["ID_Participante"])){//sino hay nada almacenado en la variable superglobal devuelve a la pagina de inicio
		...
		<div>
			<p class="pregunta">El rey Amasías fue asesinado en Laquis, luego lo llevaron a caballo hasta la ciudad de _____, donde fue sepultado con sus antepasados. </p>
		</div>
		<div class="Quinto">
			<div class="Quinto_2">    
		...
		<?php
		$_SESSION["Versiculo"] = "2 Crónicas 25:28";
	}  
