...
// session_start();//se inicia sesion para llamar las variables $_SESSION creadas en otros archivos, o para crear una.
	...
	if(!isset($_SESSION["ID_Participante"])){//sino hay nada almacenado en la variable superglobal devuelve a la pagina de inicio con esto se garantiza que el usuario entro por login
		...
		<div>
			<p class="pregunta">¿Qué rey destruyó el templo del Señor y llevó cautivo al pueblo a Babilonia?</p>
		</div>
		<div class="Quinto">
			<div class="Quinto_2">   
			...
			<div class="Quinto_2">
				...
				<p id="principiantes_01b" class="efecto" onclick="sonidoInCorrecto(); pauseAudioBiblia();llamar_bloqueo()">Darío</p>
			</div>
	</div>
		<?php
		$_SESSION["Versiculo"] = "Esdras 5:12";
	}  
