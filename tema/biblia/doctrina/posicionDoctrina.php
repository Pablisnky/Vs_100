...
// session_start();//se inicia sesion para llamar a las variables $_SESSION creadas en otros archivos, o para crearlas si es necesario
	...
	//echo "Puntos: " . $Puntaje;
		if ($Puntaje==0){
				include("preguntaBiblia_Doctrina_01.php");
		}
		else if ($Puntaje==1){
				include("preguntaBiblia_Doctrina_02.php");
		}
		else if ($Puntaje==2){
				include("preguntaBiblia_Doctrina_03.php");
		}
		else if ($Puntaje==3){
				include("preguntaBiblia_Doctrina_04.php");
		}
		else if ($Puntaje==4){
				include("preguntaBiblia_Doctrina_05.php");
		}
		else if ($Puntaje==5){
				include("preguntaBiblia_Doctrina_06.php");
		}
		else if ($Puntaje==6){
				include("preguntaBiblia_Doctrina_07.php");
		}
		else if ($Puntaje==7){
				include("preguntaBiblia_Doctrina_08.php");
		}
		else if ($Puntaje==8){
				include("preguntaBiblia_Doctrina_09.php");
		}
		else if ($Puntaje==9){
				include("preguntaBiblia_Doctrina_10.php");
		}
		else if ($Puntaje==10){
