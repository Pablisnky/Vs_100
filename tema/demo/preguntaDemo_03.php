...
<html lang="es">
	...
	<body onload="llamar_puntaje_Demo()"><!--funcion Ajax en puntaje.js que accede a BD para sumar el puntaje del participante -->
		...
		<div class="Secundario">
			...
			<div class="Quinto">
				<div class="Quinto_2">
					<p id="respuesta_a" class="efecto" onclick="llamar_bloqueo_Demo()">El avestruz</p>
					<p id="respuesta_b" class="efecto" onclick="llamar_sombrear_03b(); setTimeout(llamar_puntaje_Demo,200); ">El murcielago</p>
				</div>
				<div class="Quinto_2">
					<p id="respuesta_c" class="efecto" onclick="llamar_bloqueo_Demo()">La gallina</p>
					<p id="respuesta_d" class="efecto" onclick="llamar_bloqueo_Demo()">El pez volador</p>
				</div>
			</div>
			...
			<nav class="navegacion_1">
				...
				<a class="nav_10" href="preguntaDemo_04.php">Siguiente</a>
			</nav>
		</div>
	</body>
</html>
...
function llamar_sombrear_03b(){
    ...
    peticion.onreadystatechange = respuesta_sombrear_03b;
    peticion.setRequestHeader("content-type","application/x-www-form-urlencoded");
    peticion.send("null");
}                                                           

function respuesta_sombrear_03b(){
