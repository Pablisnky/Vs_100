...
<html lang="es">
	...
	<body onload="llamar_puntaje_Demo()"><!--funcion Ajax en puntaje.js que accede a BD para sumar el puntaje del participante -->
	    ...
	    <div class="Secundario">
			...
			<div class="Quinto">
				<div class="Quinto_2">
					<p id="respuesta_a" class="efecto" onclick="llamar_bloqueo_Demo();">La flor de la vida.</p>
					<p id="respuesta_b" class="efecto" onclick="llamar_bloqueo_Demo()">El ave fenix.</p>
				</div>
				<div class="Quinto_2">
					<p id="respuesta_c" class="efecto" onclick="llamar_sombrear_04c(); setTimeout(llamar_puntaje_Demo,200)">La medusa Turritopsis nutricula .</p>
			...
			<nav class="navegacion_1">
				...
				<a class="nav_10" href="preguntaDemo_09.php">Siguiente</a>
			</nav>
		</div>
	</body>
</html>
