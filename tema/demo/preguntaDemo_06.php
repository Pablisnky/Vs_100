...
session_start();//se inicia sesion para llamar las variables $_SESSION creadas en otros archivos, o para crear una nueva.
	 ...
	 if(!isset($_SESSION["ID_Participante"])){//sino hay nada almacenado en la variable superglobal devuelve a la pagina de inicio
		...
		define("PREGUNTA_ACTUAL", 6); // definiendo una constante para identificar el número de la pregunta actual
		define("PREGUNTA_ANTERIOR", 5); // definiendo una constante para identificar el número de la pregunta anterior
...
<html lang="es">
	...
	<body onload="llamar_puntaje()"><!--funcion Ajax en puntaje.js que accede a BD para sumar el puntaje del participante -->
	    ...
	    <div class="Secundario">
			...
			<div class="Quinto">
				<div class="Quinto_2">
					<p id="respuesta_a" class="efecto" onclick="llamar_bloqueo()">0 Celcius.</p>
					<p id="respuesta_b" class="efecto" onclick="llamar_bloqueo()">-500 fahrenheit.</p>
				</div>
				<div class="Quinto_2">
					<p id="respuesta_c" class="efecto" onclick="llamar_bloqueo()">Infinito.</p>
					<p id="respuesta_d" class="efecto" onclick="llamar_sombrear_04d(); setTimeout(llamar_puntaje,200)">0 Kelvin.</p>
				</div>
			</div>
			...
			<nav class="navegacion_1">
				...
				<a class="nav_7" href="preguntaDemo_07.php">Siguiente</a>
			</nav>
		</div>
	</body>
</html>
...
//--------------------------------------------------------------------------------------------------------------
		...
		?>
			<div class="Secundario">
				...
				<a class="nav_1" href="preguntaDemo_05.php">Volver</a>			
			</div>	
		<?php	
		}
	}
