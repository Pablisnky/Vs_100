...
<html lang="es">
	...
	<body onload="llamar_puntaje_Demo()"><!--funcion Ajax en puntaje.js que accede a BD para sumar el puntaje del participante -->
	    ...
	    <div class="Secundario">
			...
			<div class="Quinto">
				<div class="Quinto_2">
					<p id="respuesta_a" class="efecto" onclick="llamar_bloqueo_Demo()">0 Celcius.</p>
					<p id="respuesta_b" class="efecto" onclick="llamar_bloqueo_Demo()">-500 fahrenheit.</p>
				</div>
				<div class="Quinto_2">
					<p id="respuesta_c" class="efecto" onclick="llamar_bloqueo_Demo()">Infinito.</p>
					<p id="respuesta_d" class="efecto" onclick="llamar_sombrear_Demo(); setTimeout(llamar_puntaje_Demo,200)">0 Kelvin.</p>
				</div>
			</div>
			...
			<div class="contenedor_6" id="Flecha">
				<a  href='preguntaDemo_07.php'><span class="icon-arrow-right parpadea" title="Siguiente"></span></a>					
			</div>
		</div>
	</body>
</html>
