...
session_start();//se inicia sesion para llamar las variables $_SESSION creadas en otros archivos, o para crear una.
	...
	if(!isset($_SESSION["ID_Participante"])){//sino hay nada almacenado en la variable superglobal devuelve a la pagina de inicio
		...
		define("PREGUNTA_ACTUAL", 2); // definiendo una constante para identificar el número de la pregunta actual
		define("PREGUNTA_ANTERIOR", 1); // definiendo una constante para identificar el número de la pregunta anterior
	...
	<body onload="llamar_puntaje()"><!--funcion Ajax en puntaje.js que accede a BD para sumar el puntaje del participante -->
	    ...
	    <input type="text" class="ocultar" id="Pregunta_Num" value="<?php echo $Num_Pregunta;?>"><!-- se utiliza para enviar a puntaje.js-->
		    ...
		    <div class="Secundario">
				...
				<div class="Quinto">
					<div class="Quinto_2">
						<p id="respuesta_a" class="efecto" onclick="llamar_bloqueo()">Un antiguo acorde.</p><!-- llamar_bloqueo() se encuentra en bloqueo.js -->

						<p id="respuesta_b" class="efecto" onclick="llamar_bloqueo()">El carro de Condorito.</p><!-- llamar_bloqueo() se encuentra en bloqueo.js -->
					</div>
					<div class="Quinto_2">
						<p id="respuesta_c" class="efecto" onclick="llamar_bloqueo()">Un ave gigante.</p><!-- llamar_bloqueo() se encuentra en bloqueo.js -->

						<p id="respuesta_d" class="efecto" onclick="llamar_sombrear_02d(); setTimeout(llamar_puntaje,200);">Un avion supersonico.</p>
					</div>
				</div>
				...
				<a class="nav_7" href="../../index.php">Inicio</a>
						...
						<a class="nav_7" href="preguntaDemo_03.php">Siguiente</a>
						</nav>
					</div>
				</body>
			</html>
	...
	<script>
		...
		?>
			<div class="Secundario">
				...
				<a class="nav_1" href="preguntaDemo_01.php">Volver</a>			
			</div>	
		<?php	
		}
	}
