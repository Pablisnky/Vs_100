		    ...
		    <div class="Secundario">
				...
				<div class="Quinto">
					...
					<div class="Quinto_2">
						...
						<p id="respuesta_d" class="efecto" onclick="llamar_sombrear_02d(); setTimeout(llamar_puntaje_Demo,200);">Un avion de pasajeros supersonico.</p>
					</div>
				</div>
				...
				<div class="respuestaPreguntas" id="RespuestaPreguntas"><!--con el id recibe informacion desde ajax-->
					...
					<nav class="navegacion_1">
						...
						<a class="nav_10" href="preguntaDemo_03.php">Siguiente</a>
						</nav>
					</div>
				</body>
			</html>
