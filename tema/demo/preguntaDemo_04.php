	...
	<body onload="llamar_puntaje()"><!--funcion Ajax en puntaje.js que accede a BD para sumar el puntaje del participante -->
	    ...
	    <div class="Secundario">
			...
			<div class="Quinto">
				...
				<div class="Quinto_2">
					<p id="respuesta_c" class="efecto" onclick="llamar_sombrear_04c(); setTimeout(llamar_puntaje,200);">Beisbol.</p>
			...
			<nav class="navegacion_1">
				...
				<a class="nav_7" href="preguntaDemo_05.php">Siguiente</a>
			</nav>
		</div>
	</body>
</html>
...
//--------------------------------------------------------------------------------------------------------------
		...
		?>
			<div class="Secundario">
				...
				<a class="nav_1" href="preguntaDemo_03.php">Volver</a>			
			</div>	
		<?php	
		}
	}
