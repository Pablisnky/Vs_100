...
<html lang="es">
	...
	<body onload="llamar_puntaje_Demo()"><!--funcion Ajax en puntaje.js que accede a BD para sumar el puntaje del participante -->
	    ...
	    <div class="Secundario">
			...
			<div class="Quinto">
				<div class="Quinto_2">
					<p id="respuesta_a" class="efecto" onclick="llamar_bloqueo_Demo()">El Everest.</p>
					<p id="respuesta_b" class="efecto" onclick="llamar_bloqueo_Demo()">El Monte sinai.</p>
				</div>
				<div class="Quinto_2">
					<p id="respuesta_c" class="efecto" onclick="llamar_sombrear_04c(); setTimeout(llamar_puntaje_Demo,200);">El Aconcagua.</p>
					<p id="respuesta_d" class="efecto" onclick="llamar_bloqueo_Demo()">El Pico Bolivar.</p>
				</div>
			</div>
			...
			<nav class="navegacion_1">
				...
				<a class="nav_10" href="preguntaDemo_05.php">Siguiente</a>
			</nav>
		</div>
	</body>
</html>
