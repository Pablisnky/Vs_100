...
<html lang="es">
	...
	<body onload="llamar_puntaje_Demo()"><!--funcion Ajax en puntaje.js que accede a BD para sumar el puntaje del participante -->
	    ...
	    <div class="Secundario">
			...
			<div class="Quinto">
				<div class="Quinto_2">
					<p id="respuesta_a" class="efecto" onclick="llamar_bloqueo_Demo();">Dumbo</p>
					<p id="respuesta_b" class="efecto" onclick="llamar_bloqueo_Demo()">Al burrito sabanero</p>
				</div>
				<div class="Quinto_2">
					<p id="respuesta_c" class="efecto" onclick="llamar_bloqueo_Demo()">Campanita</p>
					<p id="respuesta_d" class="efecto" onclick="llamar_sombrear_Demo(); setTimeout(llamar_puntaje_Demo,200)">Pinocho</p>
				</div>
			</div>
