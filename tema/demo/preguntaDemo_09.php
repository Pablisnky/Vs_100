...
<html lang="es">
	...
	<body onload="llamar_puntaje()"><!--funcion Ajax en puntaje.js que accede a BD para sumar el puntaje del participante -->
	    ...
	    <div class="Secundario">
			...
			<div class="Quinto">
				<div class="Quinto_2">
					<p id="respuesta_a" class="efecto" onclick="llamar_bloqueo();">La cascada del Vino.</p>
					<p id="respuesta_b" class="efecto" onclick="llamar_bloqueo()">El Orinoco.</p>
				</div>
				<div class="Quinto_2">
					<p id="respuesta_c" class="efecto" onclick="llamar_bloqueo()">El mirador caraqueño.</p>
					<p id="respuesta_d" class="efecto" onclick="llamar_sombrear_04d(); setTimeout(llamar_puntaje,200)">El Salto Angel.</p>
				</div>
			</div>
			...
			<nav class="navegacion_1">
				...
				<a class="nav_7" href="preguntaDemo_10.php">Siguiente</a>
			</nav>
		</div>
	</body>
</html>
...
//--------------------------------------------------------------------------------------------------------------
		...
		?>
			<div class="Secundario">
				...
				<a class="nav_1" href="preguntaDemo_08.php">Volver</a>			
			</div>	
		<?php	
		}
	}
