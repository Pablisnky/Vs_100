	    ...
	    <div class="Secundario">
			...
			<div class="Quinto">
				...
				<div class="Quinto_2">
					...
					<p id="respuesta_d" class="efecto" onclick="llamar_sombrear_04d(); setTimeout(llamar_puntaje_Demo,200)">El Salto Angel.</p>
				</div>
			</div>
			...
			<nav class="navegacion_1">
				...
				<a class="nav_10" href="preguntaDemo_10.php">Siguiente</a>
			</nav>
		</div>
	</body>
</html>
