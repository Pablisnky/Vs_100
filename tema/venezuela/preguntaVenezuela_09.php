...
session_start();//se inicia sesion para llamar las variables $_SESSION creadas en otros archivos, o para crear una nueva.
	 ...
	 if(!isset($_SESSION["ID_Participante"])){//sino hay nada almacenado en la variable superglobal devuelve a la pagina de inicio
		...
		define("PREGUNTA_ACTUAL",9,false); // definiendo una constante para identificar el número de la pregunta actual
		define("PREGUNTA_ANTERIOR",8,false); // definiendo una constante para identificar el número de la pregunta anterior
	    ...
	    <div class="Secundario">
			...
			<div class="Quinto">
				...
				<div class="Quinto_2">
					...
					<p id="respuesta_d" class="efecto" onclick="llamar_sombrear_04d(); setTimeout(llamar_puntaje,200)">El Pico Bolivar.</p>
				</div>
			</div>
			...
			<nav class="navegacion_1">
				...
				<a class="nav_7" href="preguntaVenezuela_10.php">Siguiente</a>
			</nav>
		</div>
	</body>
</html>
...
//--------------------------------------------------------------------------------------------------------------
		...
		?>
			<div class="Secundario">
				...
				<a class="nav_1" href="preguntaVenezuela_08.php">Volver</a>			
			</div>	
		<?php	
		}
	}
