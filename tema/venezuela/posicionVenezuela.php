...
// session_start();//se inicia sesion para llamar a las variables $_SESSION creadas en otros archivos, o para crearlas si es necesario
	...
	//echo "Puntos: " . $Puntaje;
		if ($Puntaje==0){
				include("preguntaVenezuela_01.php");
		}
		else if ($Puntaje==1){
				include("preguntaVenezuela_02.php");
		}
		else if ($Puntaje==2){
				include("preguntaVenezuela_03.php");
		}
		else if ($Puntaje==3){
				include("preguntaVenezuela_04.php");
		}
		else if ($Puntaje==4){
				include("preguntaVenezuela_05.php");
		}
		else if ($Puntaje==5){
				include("preguntaVenezuela_06.php");
		}
		else if ($Puntaje==6){
				include("preguntaVenezuela_07.php");
		}
		else if ($Puntaje==7){
				include("preguntaVenezuela_08.php");
		}
		else if ($Puntaje==8){
				include("preguntaVenezuela_09.php");
		}
		else if ($Puntaje==9){
				include("preguntaVenezuela_10.php");
		}
		else if ($Puntaje==10){
