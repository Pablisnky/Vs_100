...
session_start();//se inicia sesion para llamar las variables $_SESSION creadas en otros archivos, o para crear una nueva.
	 ...
	 if(!isset($_SESSION["ID_Participante"])){//sino hay nada almacenado en la variable superglobal devuelve a la pagina de inicio
		...
		define("PREGUNTA_ACTUAL",8,false); // definiendo una constante para identificar el número de la pregunta actual
		define("PREGUNTA_ANTERIOR",7,false); // definiendo una constante para identificar el número de la pregunta anterior
...
<html lang="es">
	...
	<?php
		...
		if($Respondida>6){//Condicion que impide entrar a una pregunta sino a respondido la pregunta previa, $_SESSION creada en sumaPuntaje.php
	?>
	...
	<body onload="llamar_puntaje()"><!--funcion Ajax en puntaje.js que accede a BD para sumar el puntaje del participante -->
	    ...
	    <div class="Secundario">
			...
			<div>
				<p class="pregunta">Venezuela tuvo los edificios más altos de Latinoamérica desde 1979 hasta 2003 que fueron desplazados por La Torre Mayor de Ciudad de Mexico, estos edificios venezolanos son reconocidos actualmente como:</p>
			</div>
			<div class="Quinto">
				<div class="Quinto_2">
					<p id="respuesta_a" class="efecto" onclick="llamar_bloqueo();">La Torre Eiffel caraqueña.</p>
					<p id="respuesta_b" class="efecto" onclick="llamar_bloqueo()">La torre del Oro.</p>
				</div>
				<div class="Quinto_2">
					<p id="respuesta_c" class="efecto" onclick="llamar_sombrear_04c(); setTimeout(llamar_puntaje,200)">Las Torres de Parque Central.</p>
					<p id="respuesta_d" class="efecto" onclick="llamar_bloqueo()">La Torre Principal.</p>
				</div>
			</div>
			...
			<nav class="navegacion_1">
				...
				<a class="nav_7" href="preguntaVenezuela_09.php">Siguiente</a>
			</nav>
		</div>
	</body>
</html>
...
//--------------------------------------------------------------------------------------------------------------
		...
		?>
			<div class="Secundario">
				...
				<a class="nav_1" href="preguntaVenezuela_07.php">Volver</a>			
			</div>	
		<?php	
		}
	}
