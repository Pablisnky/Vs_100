		    ...
		    <div class="Secundario">
				...
				<div class="Quinto">
					...
					<div class="Quinto_2">
						...
						<p id="respuesta_d" class="efecto" onclick="llamar_sombrear_02d(); setTimeout(llamar_puntaje,200);">El Petroleo.</p>
					</div>
				</div>
				...
				<nav class="navegacion_1">
					...
					<a class="nav_7" href="preguntaVenezuela_03.php">Siguiente</a>
				</nav>
			</div>
		</body>
	</html>
    ...
    if (peticion.readyState == 4){
		...
		?>
			<div class="Secundario">
				...
				<a class="nav_1" href="preguntaVenezuela_01.php">Volver</a>			
			</div>	
		<?php	
		}
	}
