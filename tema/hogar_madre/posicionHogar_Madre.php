...
// session_start();//se inicia sesion para llamar a las variables $_SESSION creadas en otros archivos, o para crearlas si es necesario
	...
	$Tema= $_SESSION["Tema"] ;//en esta sesion se tiene guardado el nombre de la prueba
	...
	//echo "Puntos: " . $Puntaje;
		if ($Puntaje==0){
				include("preguntaHogar_Madre_01.php");
		}
		else if ($Puntaje==1){
				include("preguntaHogar_Madre_02.php");
		}
		else if ($Puntaje==2){
				include("preguntaHogar_Madre_03.php");
		}
		else if ($Puntaje==3){
				include("preguntaHogar_Madre_04.php");
		}
		else if ($Puntaje==4){
				include("preguntaHogar_Madre_05.php");
		}
		else if ($Puntaje==5){
				include("preguntaHogar_Madre_06.php");
		}
		else if ($Puntaje==6){
				include("preguntaHogar_Madre_07.php");
		}
		else if ($Puntaje==7){
				include("preguntaHogar_Madre_08.php");
		}
		else if ($Puntaje==8){
				include("preguntaHogar_Madre_09.php");
		}
		else if ($Puntaje==9){
				include("preguntaHogar_Madre_10.php");
		}
		else if ($Puntaje==10){
