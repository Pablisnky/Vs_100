...
session_start();//se inicia sesion para llamar las variables $_SESSION creadas en otros archivos, o para crear una nueva.
	...
	$Pais= "Colombia";
	define("PREGUNTA_ACTUAL",4,false);  // definiendo una constante para identificar el número de la pregunta
	define("PREGUNTA_ANTERIOR",3,false);  // definiendo una constante para identificar el número de la pregunta
...
<html lang="es">
	...
	<body onload="llamar_puntaje()"><!--funcion Ajax en puntaje.js que accede a BD para sumar el puntaje del participante -->
	    ...
	    <div class="Secundario">
			...
			<div class="Quinto">
				<div class="Quinto_2">
					<p id="respuesta_a" class="efecto" onclick="cerrar(); opcion_a(); llamar_bloqueo()">Santiago Villa.</p>
					<p id="respuesta_b" class="efecto" onclick="cerrar(); opcion_b(); llamar_bloqueo()">Radamel Falcao.</p>
				</div>
				<div class="Quinto_2">
					<p id="respuesta_c" class="efecto" onclick="cerrar(); llamar_sombrear_04c(); setTimeout(llamar_puntaje,200);">Juan Pablo Montoya.</p>
					<p id="respuesta_d" class="efecto" onclick="cerrar(); opcion_d(); llamar_bloqueo()">Nairo Quintana.</p>
				</div>
			</div>
			...
			<nav class="navegacion_1">
				...
				<a class="nav_7" href="preguntaColombia_05.php">Siguiente</a>
			</nav>
		</div>
	</body>
</html>
...
function llamar_sombrear_04c(){
    ...
    var url="respuestaColombia_04.php?val_1=" + E  + "&val_2=" + F + "&r=" + aleatorio;
...
//--------------------------------------------------------------------------------------------------------------
		...
		?>
			<div class="Secundario">
				...
				<a class="nav_2" href="preguntaColombia_03.php">Volver</a>			
			</div>	
		<?php	
		}
	}
