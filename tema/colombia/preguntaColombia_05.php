...
session_start();//se inicia sesion para llamar las variables $_SESSION creadas en otros archivos, o para crear una nueva.
	...
	$Pais= "Colombia";
	define("PREGUNTA_ACTUAL",5,false);  // definiendo una constante para identificar el número de la pregunta
	define("PREGUNTA_ANTERIOR",4,false);  // definiendo una constante para identificar el número de la pregunta
...
<html lang="es">
	<head>
		...
		<script src="../../javascript/muestraPuntaje.js"></script>
	...
	<body onload="llamar_puntaje()"><!--funcion Ajax en puntaje.js que accede a BD para sumar el puntaje del participante -->
	    ...
	    <div class="Secundario">
			...
			<div>
				<p class="pregunta">Que instrumentos musical es considerado el instrumeto nacional de Colombia:</p>
			</div>
			<div class="Quinto">
				<div class="Quinto_2">
					<p id="respuesta_a" class="efecto" onclick="cerrar(); opcion_a(); llamar_bloqueo()">El Acordion.</p>
					<p id="respuesta_b" class="efecto" onclick="cerrar(); opcion_b(); llamar_bloqueo()">El Cuatro.</p>
				</div>
				<div class="Quinto_2">
					<p id="respuesta_c" class="efecto" onclick="cerrar(); llamar_sombrear_05c(); setTimeout(llamar_puntaje,200);">El Tiple.</p>
					<p id="respuesta_d" class="efecto" onclick="cerrar(); opcion_d(); llamar_bloqueo()">La bandola.</p>
				</div>
			</div>	
			...
			<nav class="navegacion_1">
				...
				<a class="nav_7" href="ultimaColombia.php">Siguiente</a>
			</nav>
		</div>
	</body>
</html>
...
function llamar_sombrear_05c(){
    ...
    F=document.getElementById("Pais").value;//se inserta el nombre del Pais desde este mismo archivo.
    var url="respuestaColombia_05.php?val_1=" + E  + "&val_2=" + F + "&r=" + aleatorio;
...
//--------------------------------------------------------------------------------------------------------------
		...
		?>
			<div class="Secundario">
				...
				<a class="nav_2" href="preguntaColombia_04.php">Volver</a>			
			</div>	
		<?php	
		}
	}
