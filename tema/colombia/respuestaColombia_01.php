<?php
	...
	include("../../conexion/Conexion_BD.php");
				...
				if($Incremento >'00:00:00'){//Si el participante esta bloqueado
					...
					//echo "Hora de respuesta= " . $horaPHP;
					...
					$Insertar_4="UPDATE respuestas SET Hora_Respuesta= '$horaPHP' WHERE ID_Participante='$Participante' AND Pais='$Pais' AND ID_Pregunta='1'";
							mysqli_query($conexion,$Insertar_4);

					//consulta para verificar si existe una respuesta correcta en la pregunta Nº 1
			    	$Consulta= "SELECT * FROM respuestas WHERE ID_Pregunta='1' AND ID_Participante= '$Participante' AND Pais='$Pais'";
			    	...
			    	if(($Verificar["Correcto"])==1){ //si existe una respuesta correcta en la base de datos.
						...
						$Actualizar="UPDATE respuestas SET Correcto= 1 WHERE ID_Participante='$Participante' AND Pais='$Pais' AND ID_Pregunta='1'";
						  mysqli_query($conexion,$Actualizar);

						//se verifica si el tiempo de respuesta esta vencido
						$Consulta_3="SELECT HoraMaximo FROM respuestas WHERE ID_Participante='$Participante' AND Pais='$Pais' AND ID_Pregunta='1'";
						...
						$Consulta_4="SELECT Hora_Respuesta FROM respuestas WHERE ID_Participante='$Participante' AND Pais='$Pais' AND ID_Pregunta='1'";
